...
import { ArrowLeft, Save, X, Plus, Minus, Trash2 } from 'lucide-react'
...
export default function EditProject() {
  ...
  const fetchProject = async () => {
    try {
      const response = await fetch(`${BASE_URL}/edit/project/${projectId}`)
  ...
  if (fetching) {
    return (
      <div className="admin-dashboard">
        <div className="admin-loading">Loading project...</div>
      </div>
    )
  }
      ...
      >
        <div className="admin-form-header">
          ...
          <div className="admin-form-title-section">
            <h1 className="admin-form-title">Edit Project</h1>
            <p className="admin-form-subtitle">Update project information</p>
          </div>
        </div>
